  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
      ...
      {canCreate ? (
        ...
        <div className="flex items-center gap-3 rounded-2xl border border-amber-100 bg-amber-50/50 p-5 text-sm text-amber-800 shadow-[inset_0_1px_2px_rgba(245,158,11,0.02)]">
