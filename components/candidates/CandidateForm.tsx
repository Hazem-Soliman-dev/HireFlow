...
export default function CandidateForm({ jobId }: { jobId: string }) {
  ...
  return (
    <div className="rounded-3xl border border-slate-100 bg-white p-6 shadow-premium space-y-6 font-sans">
      ...
      <form action={submit} className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        {/* Upload Button Block */}
        <div className="sm:col-span-2 lg:col-span-4 flex flex-col gap-2 rounded-2xl bg-slate-50/30 p-4 border border-slate-100 mt-1">
          <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
            Resume (PDF Format)
          </label>
